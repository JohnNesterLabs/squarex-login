export const FlameIcon = ({ className = "w-8 h-8" }) => (
  <svg className={className} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M16 2C14 6 12 8 10 12C8 16 10 22 16 28C22 22 24 16 22 12C20 8 18 6 16 2Z"
      fill="url(#flame-gradient)"
    />
    <defs>
      <linearGradient id="flame-gradient" x1="10" y1="2" x2="22" y2="28" gradientUnits="userSpaceOnUse">
...
export const OktaIcon = ({ className = "w-5 h-5" }) => (
...
export const SearchIcon = ({ className = "w-3 h-3" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const SettingsIcon = ({ className = "w-3 h-3" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
