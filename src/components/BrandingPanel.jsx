...
const BrandingPanel = () => {
  ...
  return (
    ...
    >
      ...
      {/* Responsive: lg(1024px) -> xl(1280px) -> 2xl(1536px) */}
      <img
        src={LEFT_IMAGE_LIGHT}
        alt="Left panel light"
        className="absolute top-[42%] left-0 h-[350px] lg:h-[350px] xl:h-[420px] 2xl:h-1/2 w-auto -translate-x-[59%] lg:-translate-x-[59%] xl:-translate-x-[59%] 2xl:-translate-x-[59%] skew-x-[18.521deg] rounded-[24px] transition-all duration-500 ease-in-out"
        style={{
      ...
      <img
        ...
        className="absolute top-[12.2%] left-0 h-[350px] lg:h-[350px] xl:h-[420px] 2xl:h-1/2 w-auto translate-x-[38%] lg:translate-x-[38%] xl:translate-x-[38%] 2xl:translate-x-[38%] skew-x-[18.521deg] rounded-[24px] transition-all duration-500 ease-in-out"
        style={{
